...
const CardBerita = ({
  ...
  return (
    <Link
      href={`/berita/${beritaId}?judul=${encodeURIComponent(judul)}`}
      passHref
    >
      <div
        className={`relative w-[50vw] h-[80vw] sm:w-[30vw] sm:h-[50vw] md:w-[25vw] md:h-[44vw] lg:w-[30vw] lg:h-[40vw] xl:w-[20vw] xl:h-[30vw] rounded-2xl overflow-hidden shadow-lg flex-shrink-0 group my-2`}
      >
        <Image
          src={gambarState}
          onError={() => {
