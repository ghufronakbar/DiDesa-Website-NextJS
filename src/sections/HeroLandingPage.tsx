      ...
      >
        <div className="w-full h-full min-h-screen py-40 lg:px-32 md:px-20 px-8 gap-2 bg-black bg-opacity-25 backdrop-blur-sm">
          ...
          <Link
            ...
            target="_blank"
          >
            <button className="w-fit h-fit py-2 px-4 mt-24 mx-auto bg-primary text-white text-sm items-center flex  backdrop-blur-sm rounded-lg font-rubik gap-2 hover:scale-105 transition-all duration-300">
              {" "}
              <FaGooglePlay />
              Unduh Aplikasi
            </button>
